...
export default function CollectionsPage() {
    ...
    const createMutation = useMutation({
        mutationFn: (name: string) =>
            apiFetch('/collections', { method: 'POST', body: JSON.stringify({ name }) }),
        onSuccess: () => {
    ...
    return (
        <div className={styles.page}>
            ...
            {isLoading ? (
                ...
                <p className={styles.empty}>No collections yet. Create one to organize your sources.</p>
            ) : (
                    ...
                    {collections.map((col) => (
                        <li key={col.id} className={styles.item}>
                            <Link href={`/collections/${col.id}`} className={styles.itemLink}>
                                ...
                                {col.is_public && <span className={styles.publicBadge}>Public</span>}
                            </Link>
                            <button

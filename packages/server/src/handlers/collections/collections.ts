...
export async function getCollectionsHandler(req: Request, res: Response): Promise<void> {
...
export async function createCollectionHandler(req: Request, res: Response): Promise<void> {
    ...
    try {
        const collection = await createCollection(userId, parsed.data.name, parsed.data.description);
...
export async function addSourceToCollectionHandler(req: Request, res: Response): Promise<void> {
    const userId = req.session.userId!;
    const { id } = req.params;
...
export async function removeSourceFromCollectionHandler(req: Request, res: Response): Promise<void> {
    const userId = req.session.userId!;
...
export async function shareCollectionHandler(req: Request, res: Response): Promise<void> {
    const userId = req.session.userId!;
    const { id } = req.params;
    try {
        const collection = await getCollectionById(id, userId);
